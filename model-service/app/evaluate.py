...
def main() -> None:
    ...
    try:
        ...
        # Shot-location coverage, printed because these columns are
        # backfilled per fixture and partial coverage silently turns the
        # blend into a partial no-op -- exactly the failure mode the xg
